...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        label1.setText("Masukkan Username dan Password");
    ...
    private void buttonLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonLoginActionPerformed
        // Mengambil username dari text field
    if ("admin".equals(textUsername.getText())){
            if("admin".equals(textPassword.getText())){
             ...
             JOptionPane.showMessageDialog(rootPane, "Username Belum Terdaftar", "Username  Anda Salah", JOptionPane.ERROR_MESSAGE);
        }    
